...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.archived_date'
        db.alter_column(u'hyperkitty_email', 'archived_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Email.subject'
        db.alter_column(u'hyperkitty_email', 'subject', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Email.archived_date'
        db.alter_column(u'hyperkitty_email', 'archived_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Email.subject'
        db.alter_column(u'hyperkitty_email', 'subject', self.gf('django.db.models.fields.CharField')(max_length=u'512'))
    ...
    models = {
        ...
        u'hyperkitty.email': {
            ...
            'archived_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
